...
\begin{itemize}
  ...
  developing and testing the configuration and data logging modules. I am mostly
  adapting the python module I developed while working on QEKF project. Currently,
  I am adapting the data management module; responsible for post-processing and
  saving the data to file. Next, I will integrate the perception module into
  the system, and we will begin collecting test data. At some point, I will
  turn the UR5e example code into a module to seamlessly integrate into
  my general OOP (object-oriented programming) architecture and other projects.
  These modules will become a foundation to build upon while decreasing
  development time.\\
  \item Maicol: \\
