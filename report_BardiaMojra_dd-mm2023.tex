...
\begin{itemize}
  \item DLO Dataset (\textcolor{red}{RAL}): I worked on setting up ROS2+Docker
  environment for the DLO project but I ran out of time. ROS2+Docker environment
  seems to be the standard approach for professional robotic development. The
  Open Source Robotic Foundation builds and maintains dockerfiles and images.
  Since I ran out of time on learning ROS2; currently, I am setting up simple
  RealSense-Viewer on Ubuntu 18.04 and I am building from source. This should
  go smoothly. Autonomous Object Model Acquisition with a Robotic Arm \\
  \item Maicol: \\
