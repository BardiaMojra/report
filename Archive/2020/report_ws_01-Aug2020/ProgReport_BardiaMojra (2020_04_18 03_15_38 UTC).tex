...
\begin{itemize}  
  ...
  \item I am still trying to setup my Ubuntu environment for my research and it is difficult because of class workload. And now I have to reinstall the OS for the third time. Initially, I messed up my graphics card driver while I was trying to install OpenCV; so I reinstalled the OS because fixing it became too complicated, I wonder how does it work? Do we have to reinstall the entire setup every time there is an interrupted installation or a major driver or library faults? Anyways, then I decided to install ROS first since I need it for SLAM tutorials. Following ROS instructions, I installed ROS Kinetic but on Ubuntu 18.04 which is not compatible. Now, I need to reinstalled Ubuntu and install ROS Melodic.
  
  \item Regarding SLAM tutorial, I am still trying to get the robot running. 
